...
public sealed class JokerGameOver : CustomGameOver
{
    ...
    {
        var winColor = TouExtensionColors.Joker;
        var winText = $"{TouLocale.Get("ExtensionRoleJoker", "Joker")} {TouLocale.Get("ExtensionJokerWins", "Wins")}";
