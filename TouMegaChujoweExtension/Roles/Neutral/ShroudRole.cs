...
public sealed class ShroudRole(IntPtr cppPtr) : NeutralRole(cppPtr), ITownOfUsRole, IWikiDiscoverable, IDoomable
{
    ...
    public StringBuilder SetTabText()
    {
        ...
        var shrouded = GetCurrentShroudedPlayer();
            sb.Append('\n').Append("<b>").Append(TouLocale.GetParsed("ExtensionRoleShroudShroudedPlayer")).Append(":</b>");
            if (shrouded != null && shrouded.Data != null)
                sb.Append('\n').Append(Color.white.ToTextColor()).Append(shrouded.Data.PlayerName).Append("</color>");
        return sb;
    }
