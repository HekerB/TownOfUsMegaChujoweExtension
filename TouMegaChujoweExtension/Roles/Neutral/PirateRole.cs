    ...
    : NeutralRole(cppPtr), ITownOfUsRole, IWikiDiscoverable, IDoomable, IContinuesGame
{
    ...
    public StringBuilder SetTabText()
    {
        ...
        stringB.AppendLine("Duels Won: " + DuelsWon.ToString(System.Globalization.CultureInfo.InvariantCulture) + " / " + duelsNeeded.ToString(System.Globalization.CultureInfo.InvariantCulture));
