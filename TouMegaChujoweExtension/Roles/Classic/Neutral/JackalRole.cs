...
public sealed class JackalRole(IntPtr cppPtr) : NeutralRole(cppPtr), ITownOfUsRole, IWikiDiscoverable, IDoomable, TownOfUs.Extensions.ISpawnChange, IContinuesGame, IUnlovable
{
