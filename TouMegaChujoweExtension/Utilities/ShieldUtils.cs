...
public static class ShieldUtils
{
    ...
    public static Color GetFlashColor(ShieldType shieldType)
    {
        ...
        {
            ShieldType.Medic => TouExtensionColors.ShieldFlashes.MedicFlash,
            ShieldType.Warden => TouExtensionColors.ShieldFlashes.WardenFlash,
            ShieldType.Mirrorcaster => TouExtensionColors.ShieldFlashes.MirrorcasterFlash,
            ShieldType.Bodyguard => TouExtensionColors.ShieldFlashes.BodyguardFlash,
            ShieldType.FirstDead => Color.clear,
            ShieldType.Fairy => TouExtensionColors.ShieldFlashes.FairyFlash,
            ShieldType.Mercenary => TouExtensionColors.ShieldFlashes.MercenaryFlash,
            ShieldType.Oracle => TouExtensionColors.ShieldFlashes.OracleFlash,
            ShieldType.Cleric => TouExtensionColors.ShieldFlashes.ClericFlash,
            _ => Color.clear
        };
    }
    ...
    public static bool HandleButtonShieldClick(object button, PlayerControl target)
    {
        ...
        {
            // Vanilla kill button fallback
            PlayerControl.LocalPlayer.SetKillTimer(duration);
        }
        return true;
    }
...
#pragma warning disable S3011 // Intended accessibility bypass for reflection
