...
namespace TouMegaChujoweExtension.Patches.Charlatan;
...
public static class CharlatanReportPatches
{
    ...
    public static bool ReportButtonDoClickPrefix(ReportButton __instance)
    {
        ...
        DeadBody? targetBody = allBodies.FirstOrDefault(body => CharlatanDeceiveSystem.CanDeceiveReport(player.PlayerId, body.ParentId));
