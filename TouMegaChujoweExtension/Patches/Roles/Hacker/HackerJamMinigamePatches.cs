...
public static class HackerJamMinigamePatches
{
    ...
    public static void MapCountOverlayOnEnablePrefix(MapCountOverlay __instance)
    {
        ...
        if (HackerSystem.IsJammed && !TouMegaChujoweExtension.Buttons.Classic.Impostor.HackerDeviceButton.IsPortableDeviceOpen)
        {
    ...
    {
        if (__instance != null && HackerSystem.IsJammed && !TouMegaChujoweExtension.Buttons.Classic.Impostor.HackerDeviceButton.IsPortableDeviceOpen)
        {
