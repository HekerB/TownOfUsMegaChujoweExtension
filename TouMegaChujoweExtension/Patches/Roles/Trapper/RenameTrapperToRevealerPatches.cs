...
namespace TouMegaChujoweExtension.Patches.Roles.Trapper;
...
{
    [HarmonyPatch(typeof(TownOfUs.Roles.Crewmate.TrapperRole), "get_LocaleKey")]
    [HarmonyPostfix]
    ...
    [HarmonyPatch(typeof(TownOfUs.Roles.Crewmate.TrapperRole), "get_RoleName")]
    [HarmonyPostfix]
    ...
    [HarmonyPatch(typeof(TownOfUs.Roles.Crewmate.TrapperRole), "get_RoleDescription")]
    [HarmonyPostfix]
    ...
    [HarmonyPatch(typeof(TownOfUs.Roles.Crewmate.TrapperRole), "get_RoleLongDescription")]
    [HarmonyPostfix]
