...
public sealed class BurrowerOptions : AbstractOptionGroup<BurrowerRole>
{
    ...
    [ModdedNumberOption("ExtensionOptionBurrowerEnterDelay", 0f, 10f, 0.5f, MiraNumberSuffixes.Seconds)]
    public float EnterDelay { get; set; } = 3f;

    [ModdedNumberOption("ExtensionOptionBurrowerDigDuration", 2f, 30f, 2.5f, MiraNumberSuffixes.Seconds)]
    public float DigDuration { get; set; } = 10f;

    [ModdedNumberOption("ExtensionOptionBurrowerDigCooldown", 5f, 60f, 2.5f, MiraNumberSuffixes.Seconds)]
    ...
    [ModdedNumberOption("ExtensionOptionBurrowerEmergeVisionDuration", 0f, 30f, 2.5f, MiraNumberSuffixes.Seconds)]
