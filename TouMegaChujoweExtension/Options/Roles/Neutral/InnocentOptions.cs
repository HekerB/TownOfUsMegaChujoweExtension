...
public sealed class InnocentOptions : AbstractOptionGroup<InnocentRole>
{
    ...
    [ModdedNumberOption("ExtensionOptionInnocentForcedKillDelay", 1f, 30f, 1f, MiraNumberSuffixes.Seconds, "0")]
    public float ForcedKillDelay { get; set; } = 8f;
    ...
    public ModdedEnumOption TransformAfterTauntsInto { get; } =
        new("ExtensionOptionInnocentTransformAfterTauntsInto", (int)InnocentTransformRole.Random, typeof(InnocentTransformRole),
            ["ExtensionOptionInnocentTransformRoleRandom",
             "TouRoleAmnesiac",
             "TouRoleSurvivor",
             "TouRoleMercenary",
             "TouRoleJester"]);
