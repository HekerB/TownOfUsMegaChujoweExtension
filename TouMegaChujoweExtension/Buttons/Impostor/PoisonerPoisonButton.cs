...
public sealed class PoisonerPoisonButton : TownOfUsRoleButton<PoisonerRole>
{
    ...
    protected override void FixedUpdate(PlayerControl playerControl)
    {
        ...
        if (!playerControl.IsRole<PoisonerRole>())
        {
            _closestTarget = null;
            ClearOutline();
            if (_isPoisoning) EndPoisonWindow();
        ...
        if (_isPoisoning)
        {
            ...
            else
            {
                ...
                if (Button != null)
                {
                    ...
                    Button.cooldownTimerText.text = Mathf.CeilToInt(_poisonTimer).ToString(System.Globalization.CultureInfo.InvariantCulture);
