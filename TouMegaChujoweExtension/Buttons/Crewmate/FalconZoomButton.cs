...
public sealed class FalconZoomButton : TownOfUsRoleButton<FalconRole>
{
    ...
    private static float ZoomDuration => OptionGroupSingleton<FalconOptions>.Instance.ZoomDuration;
    private static float ZoomCooldown => OptionGroupSingleton<FalconOptions>.Instance.ZoomCooldown;
    ...
    protected override void OnClick() { /* Not used */ }
    public override void OnEffectEnd() { /* Not used */ }
