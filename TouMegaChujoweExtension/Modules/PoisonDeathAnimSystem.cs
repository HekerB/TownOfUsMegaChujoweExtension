...
public static class PoisonDeathAnimSystem
{
    ...
    {
        foreach (var clone in System.Linq.Enumerable.Where(ActiveClones.Values, clone => clone != null))
        {
    ...
    {
        return System.Linq.Enumerable.FirstOrDefault(UnityEngine.Object.FindObjectsOfType<DeadBody>(), body => body.ParentId == playerId);
    }
}
