...
public static class TouExtensionColors
{
    ...
    {
        public static Color MedicFlash => new Color32(0, 102, 0, 255);       // Dark Green
        public static Color WardenFlash => new Color32(153, 0, 255, 255);    // Purple
        public static Color ClericFlash => new Color32(0, 255, 179, 255);    // Cyan/Teal
        public static Color MirrorcasterFlash => new Color32(144, 162, 195, 255); // Silver Blue
        public static Color FairyFlash => new Color32(102, 170, 243, 255);   // Light Blue
        public static Color MercenaryFlash => new Color32(140, 102, 153, 255); // Mauve
        public static Color BodyguardFlash => new Color32(0, 35, 255, 255); // Vibrant Royal Blue (Distinct from Mirror)
        public static Color OracleFlash => new Color32(191, 0, 191, 255);    // Magenta
    }
