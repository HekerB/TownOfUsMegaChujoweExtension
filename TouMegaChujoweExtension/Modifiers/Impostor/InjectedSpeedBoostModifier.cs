...
public sealed class InjectedSpeedBoostModifier : TimedModifier, IVisualAppearance, IInjectedModifier
{
    public override string ModifierName => "Injected (Speed Boost)";
