...
public sealed class PelicanGameOver : CustomGameOver
{
    ...
    {
        var winColor = TouExtensionColors.Pelican;
        var winText = $"{TouLocale.Get("ExtensionRolePelican", "Pelican")} {TouLocale.Get("ExtensionPelicanWins", "Wins")}";

#pragma warning disable S2696 // GameHistory state must be updated here
